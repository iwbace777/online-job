...
<div class="portlet box blue">
    <div class="portlet-title">
        ...
        <div class="actions">
		    <a href="{{ URL::route('backend.purchase.history') }}" class="btn red btn-sm">Purchase</a>
		    <a href="{{ URL::route('backend.subscribe.history') }}" class="btn btn-default btn-sm">Subscribe</a>								    
	    </div>		
	</div>
